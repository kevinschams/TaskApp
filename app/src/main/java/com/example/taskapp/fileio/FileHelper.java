 ...
 * Input = when your program reads data from a file stored on the android device
 ...
 * But we are getting ahead of ourselves...before we start worrying about the format of the text,

 * let's just try to work with any text
...
/////////////
     ...
     * In Android, the OS (operating system) likes to keep track of which app/activity is trying to

     * access the devices hard drive.

     * Note that the Activity class is a subclass of Context, so an activity object can be used as a

     * parameter that calls for a Context
     ...
     * @param context       The Android OS likes to know which activity is reading/writing to the

     *                      devices harddrive.

     *                      (Remember, an activity object IS a Context)

     * @return              Returns true if the file write completed successfully
